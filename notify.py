...
push_config = {
    ...
    'BARK_PUSH': 'https://api.day.app/UxNbGBZVByvr2TayVby43X/',                    # bark IP 或设备码，例：https://api.day.app/DxHcxxxxxRxxxxxxcm/
    ...
    'PUSH_KEY': 'SCT180477T4yoDmBW4phwm5GXqIL6b0kmY',                     # server 酱的 PUSH_KEY，兼容旧版与 Turbo 版
